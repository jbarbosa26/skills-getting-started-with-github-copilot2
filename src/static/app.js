document.addEventListener("DOMContentLoaded", () => {
  ...
  async function fetchActivities() {
    try {
      ...
      // Clear and rebuild activity select options
      ...
      if (currentSelection && [...activitySelect.options].some(option => option.value === currentSelection)) {
  ...
  window.unregisterParticipant = async function(activityName, email) {
    try {
      ...
      if (response.ok) {
        ...
        console.log("Unregister successful, refreshing activities list...");
  ...
  signupForm.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        signupForm.reset();
        // Refresh the activities list to show updated participants
        console.log("Signup successful, refreshing activities list...");
        setTimeout(() => fetchActivities(), 100);
      } else {
        messageDiv.textContent = result.detail || "An error occurred";
        messageDiv.className = "error";
